...
\section*{5. Week}
I did not yet present my results of this week.
\paragraph{Review of Goals from last week}
\begin{itemize}
...
\section*{6. Week}
I presented my goals in the lab meeting.
\paragraph{Review of Goals from last week}
\begin{itemize}
	\item Planned experimental procedure in detail, came up with some unresolved questions
	\item set up experimental code with PsychoPy and replicated stimulus 
	\item used learning resources on how to do a psychophysics experiment
	\item came up with two ideas for less artifacted texture stimuli
\end{itemize}

\paragraph{Goals for coming week}
\begin{itemize}
	\item Finish pilot experiment code
	\item Take at least 2-4 hours to compare remaining model parts, possibly run original model, and find bug
	\item Take 1 hour to systemize solutions of questions
	\item If time permits: Test out less artifacted texture stimuli 
\end{itemize}
...
\paragraph{Review of Goals from last week}
\begin{itemize}
	\item Implemented trial and blocked testing loops, instruction and training, Q\&A session and data saving 
	\item I didn't take enough time for the project to completely finish experimental code nor to take time for other goals
\end{itemize}

\paragraph{Goals for coming week}
\begin{itemize}
	\item Finish data pipeline implementation, decide for final experimental conditions and approximate duration and stopping rule
	\item Take at least 2-4 hours to compare remaining model parts, possibly run original model, and find bug; redo all the analysis if so
	\item Take 1 hour to systemize solutions of questions, test out less artifacted texture stimuli and make predictions with model 
	\item Implement shorter duration and peripheral stimulus
	\item Practice experiment, get feedback from lab members and organize at least one naive experimental session
	\item start preparing your final presentation
\end{itemize}